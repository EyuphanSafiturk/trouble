...
namespace kouosl\trouble\controllers\backend;

use kouosl\trouble\models\troubleData;
use kouosl\trouble\models\UploadImage;
use Yii;
use kouosl\trouble\models\troubles;
use kouosl\trouble\models\troublesSearch;
...
/**
 * troublesController implements the CRUD actions for trouble model.
 */
class troublesController extends DefaultController
{
    ...
    public function actionManage()
    {
        ...
        $searchModel = new troublesSearch();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            if(!$model->save()){
                ...
                yii::$app->session->setFlash('flashMessage', ['type' => 'error', 'message' => Module::t('trouble', 'trouble Not Saved' )]);
    ...
    public function actionDelete($id)
    {
        ...
        troubleData::deleteAll(['trouble_id' => $id]);
    ...
    {
        if (($model = troubles::findOne($id)) !== null) {
